...
var articles = {
   'article-one' : {
    title:"Article One | Suraj Chinna",
    heading:"Article One",
    date:"Aug 17 2017",
    content:`<p>
   ...
   'article-two' : {
    title:"Article Two | Suraj Chinna",
    heading:"Article Two",
    date:"Aug 17 2017",
    content:`<p>
               this is the content of my first file this is the content of my first filethis is the content of my first filethis is the content of my first filethis is the content of my first file
   ...
   'article-three' : {
    title:"Article Three | Suraj Chinna",
    ...
    pool.query("SELECT * FROM article WHERE title = $1",[req.params.articleName], function(err,result){
        if(err){
            ...
            if(result.rows.length === 0){
                res.status(500).send('Article ont found');
            } else{
